...
public class OpenAlarmListAdapter extends BaseAdapter{
    ...
    public OpenAlarmListAdapter(Context context, ArrayList<Alarm> alarmArrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view==null){
            view = LayoutInflater.from(context).inflate(R.layout.openalarm,null);
            ...
            viewHolder.ticketOpenDate_textview = (TextView)view.findViewById(R.id.ticketOpenDate_textview);
        ...
        viewHolder.ticketOpenDate_textview.setText(alarmArrayList.get(i).getScreenContent().getTicketOpenDate());
