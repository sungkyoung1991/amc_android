...
public class MovieListThread extends Thread {

    private String menu;
    private String userId;
    private Handler handler;

    public MovieListThread(){

    }

    public MovieListThread(Handler handler, String userId, String menu){
    ...
    public void run(){
        ...
        try {
            ...
            List<Movie> movieList = restHttpClient.getMovieList(userId,menu);
            System.out.println("쓰레드 안의 Result : "+movieList);
            ...
            if(movieList == null){
                ...
                System.out.println("영화 리스트가 NOT NULL :: "+movieList);
                Message message = new Message();
                message.what = 100;
                Map<String, Object> map = new HashMap<>();
                map.put("result","있음");
